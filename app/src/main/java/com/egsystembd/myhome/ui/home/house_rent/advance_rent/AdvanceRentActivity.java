package com.egsystembd.myhome.ui.home.house_rent.advance_rent;
...
public class AdvanceRentActivity extends AppCompatActivity {
    ...
    private ActivityAdvanceRentBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_advance_rent);
            binding = ActivityAdvanceRentBinding.inflate(getLayoutInflater());
