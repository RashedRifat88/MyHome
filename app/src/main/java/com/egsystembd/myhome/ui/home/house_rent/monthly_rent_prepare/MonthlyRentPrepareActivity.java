...
import com.egsystembd.myhome.ui.home.daily_expense.DailyExpenseActivity;
        ...
        binding.tvSelectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(
                        MonthlyRentPrepareActivity.this,
...
//                    binding.tvDate.setText(date);
                ...
                tenantViewModel.getAllTenant.observe(MonthlyRentPrepareActivity.this, tenantList -> {
                    setAdapter(tenantList, selectedYear, selectedMonth);
                });
...
//            decor.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
    ...
    private void setAdapter(List<Tenant> tenantList, int year, int monthId) {
        ...
        adapter = new MonthlyRentPrepareAdapter(this, tenantList, year, monthId);
