package com.egsystembd.myhome.ui.home.house_rent.rent_collection.adapter;
...
public class RentCollectionAdapter extends RecyclerView.Adapter<RentCollectionAdapter.RentCollectionViewHolder> {
    ...
    public RentCollectionAdapter(Context context, List<Tenant> tenants, int year, int monthId) {
    ...
    @Override
    public RentCollectionViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new RentCollectionViewHolder(LayoutInflater.from(context).inflate(R.layout.single_item_rent_collection, parent, false));
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(RentCollectionViewHolder holder, int position) {
...
//        RentCollection rentCollection = getRentCollectionByDeedId(deedId);
        ...
        RentCollection rentCollection = getRentCollectionByDeedIdYearMonth(deedId, year, monthId);


//        Log.d("tag666", "rentCollection: " + rentCollection.total_payable_rent);

        holder.tv_name.setText(tenant.name);
        holder.tv_flat_no.setText("ফ্ল্যাট নং :   " + deed.flat_no);


//        holder.tv_total_payable_rent.setText("মোট প্রদেয় ভাড়া :   " + "তৈরি করা হয়নি");

//        if (holder.tv_total_payable_rent.getText().toString().equalsIgnoreCase("মোট প্রদেয় ভাড়া :   " + "তৈরি করা হয়নি")) {
...
//        }
        ...
        holder.tv_total_rent_collection.setText("ভাড়া আদায়:   " + rentCollection.total_collect);
        holder.tv_total_rent_remain.setText("ভাড়া বাকী:   " + rentCollection.remaining_amount);

        if (rentCollection.remaining_amount == 0.0){
            holder.tv_create_rent_colllection.setVisibility(View.GONE);
        }
...
//
//            holder.tv_total_rent.setText("মোট ভাড়া :   " + "তৈরি করা হয়নি");
//
//            holder.tv_create_rent.setVisibility(View.VISIBLE);
//            holder.tv_correction.setVisibility(View.GONE);
//
...
//
//            holder.tv_total_rent.setText("মোট ভাড়া :   " + rent.total_payable_rent);
//
//            holder.tv_correction.setVisibility(View.VISIBLE);
//            holder.tv_create_rent.setVisibility(View.GONE);
//        }

        holder.tv_create_rent_colllection.setOnClickListener(v -> {
...
//            noteViewModel.updateTenant(note1);
    ...
    private RentCollection getRentCollectionByDeedIdYearMonth(int deedId, int year, int monthId) {
        return rentCollectionViewModel.getSpecificRentCollection(deedId, year, monthId);
    }


    class RentCollectionViewHolder extends RecyclerView.ViewHolder {

        TextView tv_name, tv_flat_no, tv_total_rent_collection, tv_total_rent_remain, tv_correction, tv_create_rent_colllection;
        View view_note_priority;
        ImageView iv_more, iv_tick;

        public RentCollectionViewHolder(View itemView) {
            super(itemView);

            tv_name = itemView.findViewById(R.id.tv_name);
            tv_flat_no = itemView.findViewById(R.id.tv_flat_no);
            tv_total_rent_collection = itemView.findViewById(R.id.tv_total_rent_collection);
            tv_total_rent_remain = itemView.findViewById(R.id.tv_total_rent_remain);
            tv_correction = itemView.findViewById(R.id.tv_correction);
            tv_create_rent_colllection = itemView.findViewById(R.id.tv_create_rent_colllection);
